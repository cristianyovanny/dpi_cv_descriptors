...
if __name__ == '__main__':
    ...
    hog_feat_path = os.path.join(BASE_DIR, 'features', 'hog')
    X_train, y_train, X_test, y_test = load_data(hog_feat_path)
    ...
    model.save(os.path.join(BASE_DIR, 'features/models', 'hog_model.keras'))
    print("[✔] Modelo HOG guardado en 'models/hog_model.keras'")
